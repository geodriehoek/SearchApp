...
public class ProductQueryBuilder {
...

    {
        ...
        textFieldsListWithWeights.put("productName", 1.0f);      //productName minste weight aangezien enigste analyzed-field?
        textFieldsListWithWeights.put("grp_id", 2.0f);
        textFieldsListWithWeights.put("upc", 2.0f);
    }

    public SearchRequest buildMultiFieldQuery(String stringToSearch,
